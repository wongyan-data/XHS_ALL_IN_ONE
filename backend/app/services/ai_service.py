...
class OpenAICompatibleTextClient:
    ...
    def rewrite_note(
        ...
        *,
        ...
        system_prompt = (
            ...
            "2. 禁用AI八股过渡词：严禁使用“首先/其次/最后”、“不仅而且”、“一方面另一方面”、“值得一提的是”、“不可否认”、“综上所述”等连接词。\n"
            "3. 禁用AI高频行话大词：严禁使用“赋能”、“打造”、“聚焦”、“闭环”、“底层逻辑”、“沉淀”、“深耕”、“助力”等商业行话。\n"
            ...
            "7. 真人写作瑕疵：允许包含自嘲、反悔或语气修正（如“扯远了，回到正题”、“写到这里我自己都觉得在扯淡”）。\n"
    ...
    def generate_note(
        ...
        *,
        ...
        system_prompt = (
            "你是小红书内容策划，输出可直接发布、高爆款潜质、且毫无AI八股味的标题和正文。\n"
            "请务必在撰写正文时遵守以下【反AI强制规范】：\n"
            "1. 句长抖动：穿插长短句，避免长短单一，每隔3-4句长句必须插入一句5-12字的破句短句（如“对。”、“先别急。”）。\n"
            "2. 禁用AI八股过渡词：严禁使用“首先/其次/最后”、“不仅而且”、“一方面另一方面”、“值得一提的是”、“不可否认”、“综上所述”等连接词。\n"
            "3. 禁用AI高频行话大词：严禁使用“赋能”、“打造”、“聚焦”、“闭环”、“底层逻辑”、“沉淀”、“深耕”、“助力”等商业大词。\n"
            "4. 首段场景化破冰：严禁使用宏观背景引入（如“随着...发展”），首句直接使用具体数字、金句对话、真实冲突事实或个人经历作为钩子。\n"
            "5. 第一人称与主观立场：全文需多次出现第一人称“我”，加入个人主观表达与不确定语气（如“我可能说错”、“这只是我的感觉”），避免全知冷漠陈述。\n"
            "6. 标点多样性：必须使用破折号（——）、设问问号（？）、括号插入语（...），省略号（...）最多2次。\n"
            "7. 真人写作瑕疵：允许包含自嘲、反悔或语气修正（如“扯远了，回到正题”、“写到这里我自己都觉得在扯淡”）。\n"
